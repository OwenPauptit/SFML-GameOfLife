...
namespace Aesel {
	...
	Game::Game(int width, int height, std::string title) {
		...
		_data->stateMGR.ChangeState(StateRef(new MainMenuState(_data)));//GameState(_data, DEFAULT_GRID_WIDTH, DEFAULT_GRID_HEIGHT, DEFAULT_CELL_WIDTH, DEFAULT_CELL_HEIGHT, time(0),SIDECAR_GUN_FILEPATH)));
